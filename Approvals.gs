...
var destination = destinationSheet.getSheetByName('Calculations');
var responseDest = destination.getRange(4,2,1,1);
var approverDest = destination.getRange(5,2,1,1);
var feedbackDest = destination.getRange(7,2,1,1);
var timestampDest = destination.getRange(6,2,1,1); 
