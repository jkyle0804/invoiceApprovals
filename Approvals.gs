...
var responseDest = destination.getRange(4,5,1,1);
var approverDest = destination.getRange(5,5,1,1);
var feedbackDest = destination.getRange(7,5,1,1);
var timestampDest = destination.getRange(6,5,1,1); 
